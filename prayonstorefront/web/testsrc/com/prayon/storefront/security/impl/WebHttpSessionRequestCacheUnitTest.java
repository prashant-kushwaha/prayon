...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/prayonstorefront/electronics/en",
						"https://electronics.local:9002/prayonstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/prayonstorefront/electronics/en",
						"https://electronics.local:9002/prayonstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/prayonstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/prayonstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/prayonstorefront/electronics/en",
						"https://electronics.local:9002/prayonstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/prayonstorefront",
						"https://electronics.local:9002/prayonstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/prayonstorefront",
						"https://electronics.local:9002/prayonstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/prayonstorefront/electronics/en",
						"https://electronics.local:9002/prayonstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
