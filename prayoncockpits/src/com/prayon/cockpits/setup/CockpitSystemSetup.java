 ...
 */
package com.prayon.cockpits.setup;
...
import com.prayon.cockpits.constants.PrayonCockpitsConstants;
 ...
 */
@SystemSetup(extension = PrayonCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(PrayonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(PrayonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						PrayonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/prayoncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
